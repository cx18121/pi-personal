...
After the child returns, follow [Review steps 6 to 8](playbooks/review.md) for finding disposition, authorized fixes, targeted verification, and completion. That route owns the scope boundary and the conditions for another full review.
