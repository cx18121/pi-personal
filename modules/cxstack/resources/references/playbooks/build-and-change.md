...
Feature, Diagnose and Fix, Performance, Refactor, and Prototype use this spine. Copy these five steps into Todo, then add the active route's specific steps under the named spine step.
...
Verification is a question, not a ritual. A check earns its run when failure would teach something about the changed contract. Project guidance decides the useful scope. Long checks use the project's supported monitor without flooding the main conversation.
