...
6. **Compare credible directions.** Explain what each solves, does not solve, changes permanently, costs to maintain, requires for rollout, and needs for proof. When a recommendation turns on a cost that is cheap to measure, measure it before choosing. State a recommendation and why alternatives lost. Apply Readiness Review when its triggers apply.
