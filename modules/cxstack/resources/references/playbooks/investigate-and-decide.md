...
6. **Compare credible directions.** Explain what each solves, does not solve, changes permanently, costs to maintain, requires for rollout, and needs for proof. State a recommendation and why alternatives lost. Apply Readiness Review when its triggers apply.
